...
function setRequirements(uint256 _idx, string _ref, string _info, string _info1, string _info2, string _info3) {

requirements[_idx] = Data(now, _ref, _info,_info1,_info2,_info3);
